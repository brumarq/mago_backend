...
# def get_aggregated_logs(self, date_type, device_id, field_id):
...
#         with self.client:
#             response = get_aggregated_logs(self, "Daily", 1, 1)
...
#         with self.client:
#             response = get_aggregated_logs(self, "Yearly", 1, 1)
...
#         with self.client:
#             response = get_aggregated_logs(self, "Weekly", 1, 1)
#             self.assertEqual(response.status_code, 200)
#             self.assertEqual(response.headers['Content-Type'], 'application/json')

#     def test_valid_date_type_should_return_true_for_valid_enum_value(self):
#         with self.client:
#             response = get_aggregated_logs(self, 'Monthly', 1, 1)
